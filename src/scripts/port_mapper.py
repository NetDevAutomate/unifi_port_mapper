...
def main():
    ...
    parser = argparse.ArgumentParser(description='UniFi Port Mapper - Map ports on UniFi devices')
    ...
    parser.add_argument('--dry-run', action='store_true',
                        help='Dry run mode (do not apply changes)')
    parser.add_argument('--no-diagram', action='store_true',
                        help='Do not generate network diagram')
    parser.add_argument('--no-report', action='store_true',
                        help='Do not generate port mapping report')
