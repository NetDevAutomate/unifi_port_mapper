...
class DeviceCapabilityDetector:
    ...
    PROBLEMATIC_FIRMWARE = {
        ...
        '6.5.59': ['Adoption failures', 'SSH connectivity issues', 'Firmware update failures'],
    }
    ...
    def detect_capabilities(self, device_model: str, firmware_version: str) -> DeviceCapability:
    ...
    def should_attempt_port_naming(
        self, device_model: str, firmware_version: str
    ) -> Tuple[bool, str]:
        ...
        if capability.port_naming_support == PortNamingSupport.NOT_SUPPORTED:
            ...
            return (
                True,
                f'Model {device_model} has limited port naming support - proceed with caution',
            )

        else:  # FULL_SUPPORT
            return True, 'Device supports reliable port naming'

    def get_recommended_strategy(self, device_model: str, firmware_version: str) -> Dict[str, Any]:
    ...
    def generate_compatibility_report(self, devices: List[Dict[str, Any]]) -> str:
